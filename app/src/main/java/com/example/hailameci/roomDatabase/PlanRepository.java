...
import com.example.hailameci.roomDatabase.PlanDao;
import com.example.hailameci.roomDatabase.PlanDatabase;
...
public class PlanRepository {
    ...
    public PlanRepository(Application application) {
        PlanDatabase database = PlanDatabase.getInstance(application);
